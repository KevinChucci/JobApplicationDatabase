...
namespace JobApplicationDatabase {
    ...
    public partial class JobsDataSet : global::System.Data.DataSet {
        ...
        public partial class applicationsDataTable : global::System.Data.TypedTableBase<applicationsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public applicationsRow AddapplicationsRow(int Id, string Company, string City, string State, string Position, string Date) {
        ...
        public partial class applicationsRow : global::System.Data.DataRow {
            ...
            public string Company {
                get {
                    return ((string)(this[this.tableapplications.CompanyColumn]));
                }
                set {
                    this[this.tableapplications.CompanyColumn] = value;
                }
            }
            ...
            public string State {
                get {
                    try {
                        return ((string)(this[this.tableapplications.StateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'State\' in table \'applications\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableapplications.StateColumn] = value;
                }
            }
            ...
            public string Position {
                get {
                    return ((string)(this[this.tableapplications.PositionColumn]));
                }
                set {
                    this[this.tableapplications.PositionColumn] = value;
                }
            }
            ...
            public bool IsStateNull() {
                return this.IsNull(this.tableapplications.StateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetStateNull() {
                this[this.tableapplications.StateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace JobApplicationDatabase.JobsDataSetTableAdapters {
    ...
    public partial class applicationsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[applications] WHERE (([Id] = @Original_Id) AND ([Company] = @Original_Company) AND ([City] = @Original_City) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ([Position] = @Original_Position) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[applications] ([Id], [Company], [City], [State], [Position], [" +
                "Date]) VALUES (@Id, @Company, @City, @State, @Position, @Date);\r\nSELECT Id, Comp" +
                "any, City, State, Position, Date FROM applications WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[applications] SET [Id] = @Id, [Company] = @Company, [City] = @City, [State] = @State, [Position] = @Position, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([Company] = @Original_Company) AND ([City] = @Original_City) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ([Position] = @Original_Position) AND ([Date] = @Original_Date));
SELECT Id, Company, City, State, Position, Date FROM applications WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::JobApplicationDatabase.Properties.Settings.Default.JobsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Company, City, State, Position, Date FROM dbo.applications";
        ...
        public virtual int Fill(JobsDataSet.applicationsDataTable dataTable) {
        ...
        public virtual JobsDataSet.applicationsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            JobsDataSet.applicationsDataTable dataTable = new JobsDataSet.applicationsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(JobsDataSet.applicationsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Company, string Original_City, string Original_State, string Original_Position, string Original_Date) {
        ...
        public virtual int Insert(int Id, string Company, string City, string State, string Position, string Date) {
        ...
        public virtual int Update(int Id, string Company, string City, string State, string Position, string Date, int Original_Id, string Original_Company, string Original_City, string Original_State, string Original_Position, string Original_Date) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Company, string City, string State, string Position, string Date, int Original_Id, string Original_Company, string Original_City, string Original_State, string Original_Position, string Original_Date) {
            return this.Update(Original_Id, Company, City, State, Position, Date, Original_Id, Original_Company, Original_City, Original_State, Original_Position, Original_Date);
        }
    }
